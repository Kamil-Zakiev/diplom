...
namespace EC_Console
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                results.AddRange(MultithreadLenstra.UseThreadsParallelism(path, threadsCount: 100));
            }
            ...
            var groupResult = results
                ...
                (key, resultsOfGroup) =>
                {
                    ...
                    var averageSecondsOfSuccess = r.Where(x => x.Success).Average(z => z.WastedTime.TotalSeconds);
